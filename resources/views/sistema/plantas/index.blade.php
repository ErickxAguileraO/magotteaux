            ...
            <div>
                ...
                <div class="div-contenido">
                    <div class="div-contenido-escritorio">
                        <div class="div-contenido-inicio">
                            <h2>Detalle</h2>
                            <a href="{{ route('planta.download.excel') }}" class="btn-contenido-inicio">
                                <p>Descargar Excel</p>
                                <img src="{{ asset('web/imagenes/i-exel.svg') }}" alt="">
                            </a>
                        </div>
                        <div id="container-datagrid" data-link="{{ route('planta.list') }}" data-link-edit="{{ route('planta.edit', ':id') }}" data-link-delete="{{ route('planta.delete', ':id') }}"></div>
                    </div>
                </div>
