         ...
         <div class="grid-nueva-carga">
            ...
            <div class="grid-carga-n g-2">
               ...
               <div class="label-input-n">
                  ...
                  <input type="datetime-local" class="input-fecha" id="fecha_carga" name="fecha_carga" min="{{ now()->subDay(1)->format('Y-m-d\TH:i') }}" max="{{ now()->format('Y-m-d 23:59') }}" value="{{ old('fecha_carga') }}">
                  @error('fecha_carga')
                     <span class="invalid-feedback badge alert-danger" role="alert">
                        <strong>{{ $message }}</strong>
                     </span>
               ...
               <div class="label-input-n">
                  ...
                  <input type="datetime-local" class="input-fecha" id="fecha_salida" name="fecha_salida" min="{{ now()->format('Y-m-d 00:00') }}" value="{{ old('fecha_salida') }}">
                  @error('fecha_salida')
                     <span class="invalid-feedback badge alert-danger" role="alert">
                        <strong>{{ $message }}</strong>
                     </span>
            ...
            <div class="grid-carga-n g-3">
               ...
               <div class="label-input-n">
                  ...
                  <div class="input-file-simple">
                     ...
                     <input type="file" name="guia_despacho" id="guia_despacho" class="file-simple" accept=".jpg,.jpeg,.png,.doc,.docx,.pdf">
                  </div>
                  @error('guia_despacho')
                     <span class="invalid-feedback badge alert-danger" role="alert">
                        <strong>{{ $message }}</strong>
               ...
               <div class="label-input-n">
                  ...
                  <div class="input-file-simple">
                     ...
                     <input type="file" name="certificado_calidad" id="certificado_calidad" class="file-simple" accept=".jpg,.jpeg,.png,.doc,.docx,.pdf">
                  </div>
         ...
         <div class="grid-carga-n-row-2 g-4">
            <div class="label-input-n">
               ...
               <div class="input-file-pro">
                  ...
                  <input type="file" name="foto_patente" id="input-file-preview2" class="file-simple input-file-preview">
            ...
            <div class="label-input-n">
               ...
               <div class="input-file-pro">
                  <img src="{{ asset('web/imagenes/i-file-img.svg') }}" alt="">
                  <input type="file" name="foto_carga" id="input-file-preview" class="file-simple input-file-preview">
