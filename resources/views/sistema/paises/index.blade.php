            ...
            <div>
                ...
                <div class="div-contenido">
                    <div class="div-contenido-escritorio">
                        <div class="div-contenido-inicio">
                            <h2>Detalle</h2>
                            <a href="{{ route('pais.download.excel') }}" class="btn-contenido-inicio">
                                <p>Descargar Excel</p>
                                <img src="{{ asset('web/imagenes/i-exel.svg') }}" alt="">
                            </a>
                        </div>
                        <div id="container-datagrid" data-link="{{ route('pais.list') }}" data-link-edit="{{ route('pais.edit', ':id') }}" data-link-delete="{{ route('pais.delete', ':id') }}"></div>
                    </div>
                </div>
            ...
            columns: [
               ...
               },
               {
                  ...
                  cellTemplate(container, options) {
                     ...
                     const link_delete = '<a href="' + url_delete + '" class="tooltip delete-confirmation" title="Eliminar" data-message="este país"><img class="pointer-event-none" src="/web/imagenes/i-borrar-red.svg" alt=""></a>';
